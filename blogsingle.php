      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="news_items">
            ...
            <!-- News Item -->
            <?php if(!empty($single_blog)) {    ?>  
            <div class="news_item">
              <div class="news_image_container">
                <div class="news_image"><img src="<?php echo $single_blog->image; ?>" alt=""></div>
              ...
              <div class="news_body">
                <div class="news_title"><a href="<?php echo 'blogsingle.php?bid='. $value['bid']; ?>"><?php echo $single_blog->title; ?></a></div>
                <div class="news_info">
                  <ul>
                    <!-- News Author -->
                    <li>
                      <div class="news_author_image"><img src="images/news_author_1.jpg" alt=""></div>
                      <span>by <a href="#"><?php echo $single_blog->author; ?></a></span>
                    </li>
                    <!-- Tags -->
                    <li><span>in <a href="events.php">Events</a></span></li>
                    <!-- Comments -->
                    <li><a href="#">3 Comments</a></li>
                    <li>Posted on:<?php echo $single_blog->created_date; ?></li>
                  </ul>
                </div>
                <div class="news_text">
           ...
           <div class="card my-4">
            ...
            <div class="card-body">
              <form method="post" action="CommentController.php">
                <input type="hidden" name="blog_id" value="<?php echo $single_blog->bid; ?>">
